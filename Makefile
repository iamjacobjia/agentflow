...
help:
	@printf '%s\n' \
	  ...
	  '  verify-local  Run the full local Codex + Claude-on-Kimi verification stack across external doctor, inspect, check-local, and run paths (shared timeout via AGENTFLOW_LOCAL_VERIFY_TIMEOUT_SECONDS)' \
